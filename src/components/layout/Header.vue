<template>
  <header class="py-4">
      <div class="container px-4 mx-auto flex justify-between items-center">
        <div class="font-mono text-4xl font-semibold leading-none">
          <a href="/">Валютник</a>
        </div>
        <div> 
            <a href="#" title="Открыть Github" class="flex items-center gap-2 break-normal bg-zinc-800 hover:bg-zinc-700 active:bg-zinc-900 text-slate-50 pl-2 pr-3 py-2 rounded-full transition-colors">
